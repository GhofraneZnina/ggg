 ...
 */
final class Version20230222134203 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE nageur ADD email VARCHAR(255) NOT NULL, ADD password VARCHAR(255) NOT NULL, ADD nom VARCHAR(255) NOT NULL, ADD prenom VARCHAR(255) NOT NULL, CHANGE profil_facebook profil_facebook VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE nageur DROP email, DROP password, DROP nom, DROP prenom, CHANGE profil_facebook profil_facebook VARCHAR(255) DEFAULT NULL');
    }
}
