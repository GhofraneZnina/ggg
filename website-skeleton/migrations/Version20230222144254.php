 ...
 */
final class Version20230222144254 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE utilisateur ADD nageur_id INT DEFAULT NULL, ADD entraineur_id INT DEFAULT NULL, ADD parent_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE utilisateur DROP nageur_id, DROP entraineur_id, DROP parent_id');
    }
}
