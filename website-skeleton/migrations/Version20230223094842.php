 ...
 */
final class Version20230223094842 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE lieu_entrainement ADD seance_id INT NOT NULL, ADD competition_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE lieu_entrainement ADD CONSTRAINT FK_23060B35E3797A94 FOREIGN KEY (seance_id) REFERENCES seance (id)');
        $this->addSql('ALTER TABLE lieu_entrainement ADD CONSTRAINT FK_23060B357B39D312 FOREIGN KEY (competition_id) REFERENCES competition (id)');
        $this->addSql('CREATE INDEX IDX_23060B35E3797A94 ON lieu_entrainement (seance_id)');
        $this->addSql('CREATE INDEX IDX_23060B357B39D312 ON lieu_entrainement (competition_id)');
        ...
        $this->addSql('ALTER TABLE saison ADD tableau_minimas_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE lieu_entrainement DROP FOREIGN KEY FK_23060B357B39D312');
        $this->addSql('DROP INDEX IDX_23060B35E3797A94 ON lieu_entrainement');
        $this->addSql('DROP INDEX IDX_23060B357B39D312 ON lieu_entrainement');
        $this->addSql('ALTER TABLE lieu_entrainement DROP seance_id, DROP competition_id');
        ...
        $this->addSql('ALTER TABLE saison DROP tableau_minimas_id');
