 ...
 */
final class Version20230223085554 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE presence_entraineur (presence_id INT NOT NULL, entraineur_id INT NOT NULL, INDEX IDX_1F4098A1F328FFC4 (presence_id), INDEX IDX_1F4098A1F8478A1 (entraineur_id), PRIMARY KEY(presence_id, entraineur_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE presence_entraineur ADD CONSTRAINT FK_1F4098A1F328FFC4 FOREIGN KEY (presence_id) REFERENCES presence (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE presence_entraineur ADD CONSTRAINT FK_1F4098A1F8478A1 FOREIGN KEY (entraineur_id) REFERENCES entraineur (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE presence_entraineur DROP FOREIGN KEY FK_1F4098A1F328FFC4');
        $this->addSql('ALTER TABLE presence_entraineur DROP FOREIGN KEY FK_1F4098A1F8478A1');
        $this->addSql('DROP TABLE nageur_categorie');
        $this->addSql('DROP TABLE nageur_cotisation_annuelle');
        $this->addSql('DROP TABLE presence_entraineur');
